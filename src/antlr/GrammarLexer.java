...
public class GrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "FUNC", "IF", "ELSE", 
			"WHILE", "DO", "SWITCH", "CASE", "REPEAT", "UNTIL", "FOR", "INT", "BOOLEAN", 
			"STRING", "MINUS", "PLUS", "MULT", "DIVISION", "CONST", "LEFT_ROUND_PARENTHESIS", 
